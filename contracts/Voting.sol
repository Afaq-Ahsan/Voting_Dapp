...
contract Voting {
  ...
  bool public Voting_Status = true;
  ...
  bytes32[3] public candidateList = [bytes32("Ayaz"), ("Sibghat"), ("Ahsan")];
//   bytes32[] public courseMap = [bytes32("Chinese"), "English", "Math", "Computer", "Music"];
   ...
   */
  function voteForCandidate(bytes32 candidate, uint votesInTokens) public isVoting {
  ...
  function buy() payable public isVoting returns (uint) {
  ...
  function allCandidates() view public returns (bytes32[3]) {
